  ...
  return (
    <section className="relative bg-gradient-to-br from-wood-50 to-wood-100 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <svg width="60" height="60" viewBox="0 0 60 60" className="fill-current text-wood-600">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-wood-700 leading-relaxed max-w-md">
                Transform your space with bespoke wooden furniture, crafted with traditional 
                techniques and modern design sensibility.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button asChild variant="outline" size="lg" className="border-wood-600 text-wood-600 hover:bg-wood-50">
                <Link to="/custom">
                  Custom Order
                </Link>
              </Button>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-wood-800">Premium Quality</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-wood-200 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <div className="aspect-square bg-gradient-to-br from-wood-200 to-wood-300 rounded-2xl shadow-2xl overflow-hidden">
              ...
              <div className="w-full h-full flex items-center justify-center bg-wood-200">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-wood-600 font-medium">Beautiful Wooden Furniture</p>
                  <p className="text-wood-500 text-sm">Hero image placeholder</p>
                </div>
              </div>
            </div>
